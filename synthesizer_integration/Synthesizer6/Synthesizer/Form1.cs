...
namespace Synthesizer
{
    public partial class Form1 : Form
    {
        ...
        private void HearingTestPlayBtn_Click(object sender, EventArgs e)
        {
            ...
            //_ISBeats.RightFrequencyOutPut = Convert.ToDouble(FrequencyForRightSpeakerTxt.Text);
            //_ISBeats.BufferLength = (long)(Convert.ToDouble(timeTxt.Text) * 44100D * 2D);
        ...
        private void RainFallPlayBtn_Click(object sender, EventArgs e)
        {
            ...
            _throatSinging.Bufferlength = 44100 * 2;
            ...
            //long n_samples = 44100 * 2;
            //int status = throatSinging_play(amplitude, frequency, n_samples);
            //int status = throatSinging_play(_throatSinging.Amplitude, _throatSinging.Frequency, 2 * 44100);
